...
<div class="txt-heading">Keranjang Belanja <a id="btnEmpty" href="Kategori-sepeda.php?action=empty#services">Kosongkan Keranjang</a></div>
...
<div id="product-grid">
  ...
  <?php
 $cat = $_GET["Kategori"] ;
  $product_array = $db_handle->runQuery("SELECT * FROM tbl_sepeda WHERE `Kategori` = $cat  ORDER BY id ASC");
  if (!empty($product_array)) { 
    foreach($product_array as $key=>$value){
  ?>
    <div class="product-item">

      <form method="post" action='Kategori-sepeda.php?Kategori="Sepeda Gunung"&action=add&code=<?php echo $product_array[$key]["code"]; ?>#services'>
