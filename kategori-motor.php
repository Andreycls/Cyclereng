    ...
    <div class="header-content clearfix"> <a href="home.html"><img  src="images/logo-cycle.png" width="200px" height="60px" ></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          ...
          <li><a href="info.html#cara-sewa">Cara Memesan</a></li>
...
<!-- services section -->
<?php 
$CatTitle = $_GET["Kategori"];

 echo "<h2 align='center'>Kategori $CatTitle  </h2>"
?>
  <div class="container">
    <div class="row">
...
<div class="txt-heading">Keranjang Belanja <a id="btnEmpty" href="Kategori-motor.php?action=empty#services">Kosongkan Keranjang</a></div>
...
<?php   
    ...
    ?>
        ...
        <a href="penyewaan-motor.php?action=remove&code=<?php echo $item["code"];?>#services" class="btnRemoveAction">Hapus </a></td>
        </tr>
        <?php
...
<div id="product-grid">
  ...
  <?php
 $cat = $_GET["Kategori"] ;
  $product_array = $db_handle->runQuery("SELECT * FROM tbl_sepeda_motor WHERE `Kategori` = $cat  ORDER BY id ASC");
  if (!empty($product_array)) { 
    foreach($product_array as $key=>$value){
  ?>
    <div class="product-item">

      <form method="post" action='Kategori-motor.php?Kategori="Motor Bebek"&action=add&code=<?php echo $product_array[$key]["code"]; ?>#services'>
