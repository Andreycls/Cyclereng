...
$maxID = "SELECT MAX(id) FROM tbl_hasil_penyewaan";
$sqlID = mysqli_query($connect, $maxID);
$dataID = mysqli_fetch_array($sqlID);
$id=$dataID['MAX(id)'];
$querys = " SELECT * FROM tbl_hasil_penyewaan WHERE id = $id ";
...
echo "</tr>";
echo "<tr>";
echo "<td><h5><b>Nama sepeda   &nbsp; &nbsp;  : </b></td><td><h5><b>".$data['Kode_unik']."</b></td><td><h5><b>Nama penyedia : </b></td><td><h5><b>Relita Manik</b></td>";
echo "</tr>";
echo "<tr>";
echo "<td><h5><b>Jenis Sepeda &nbsp;  &nbsp; : </b></td><td><h5><b>Sepeda Gunung</b></td><td><h5><b>Alamat : </b></td><td><h5><b>Jalan.Sosor Galung No.10,<br>Tuktuk Siadong</b></td>";
echo "</tr>";
...
<li><p>Untuk pengambilan sepeda/sepeda motor yang akan  disewakan, anda dapat <i>Screenshot</i> halaman ini sebagai bukti penyewaan </p>          
...
";
$ss = "https://rest.nexmo.com/sms/json?api_key=f7dce1f0&api_secret=b0382fc95f1929a0&to=6282368455879&from='Andrey'&text='Pesanan_dengan_nomor_HP_(6282368455879)_belum_dikonfirmasi,_silahkan_konfirmasi_Segera'";
echo "           
