...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM tbl_sepeda_motor WHERE code='" . $_GET["code"] . "'");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p align="center">Jika Penyedia belum mengkonfirmasi pesanan, maka dapat mengirim SMS ke Penyedia melalui tombol "Kirim SMS ke Penyedia" </p>          
                 <form action="proses_sewa_motor.php" method="POST">
                 <p align="center">
...
<h2 align="center">Penyewaan sepeda motor daerah Tuktuk, Samosir</h2>
<br>
  <div class="container">
    <div class="row">
...
<div class="txt-heading">Keranjang Belanja <a id="btnEmpty" href="penyewaan-sepeda-motor.php?action=empty#services">Kosongkan Keranjang</a></div>
...
<tbody>
<tr>
<th style="text-align:left;"><strong>Nama Sepeda Motor</p><p></strong></th>
...
<?php   
    ...
    ?>
        ...
        <a href="penyewaan-sepeda-motor.php?action=remove&code=<?php echo $item["code"];?>#services" class="btnRemoveAction">Hapus</a></td>
        </tr>
        <?php
...
<td colspan="5" align=right><br><strong>Total:</strong> <?php echo "Rp ".$item_total.".000"; ?></td>
    <tr>
...
<div class="modal fade" id="Proses" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <p align="left">no HP :&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; <input type="number" name="No_HP"></p>
...
<a href='Kategori-motor.php?Kategori="Motor Matic"'>
  <div id="category-item">

      <form method="post" >
  <div class="category-image"><img src="images/mot2.png"></div>
            <br><br><br><br>
      <div><p style="color: #3e4444"><strong>Motor Matic</strong></div>
...
<a href='Kategori-motor.php?Kategori="Motor Bebek"'>
<div id="category-item">


      <form method="post" action="penyewaan-motor.php ?>#services">
  <div class="category-image"><img src="images/mot4.png"></div>

            <br><br><br><br>
      <div><p style="color: #3e4444"><strong>Motor Bebek</strong></div>
...
<div id="product-grid">
  ...
  <?php
  $product_array = $db_handle->runQuery("SELECT * FROM tbl_sepeda_motor ORDER BY id ASC");
  if (!empty($product_array)) { 
    foreach($product_array as $key=>$value){
  ?>
    <div class="product-item">

      <form method="post" action="penyewaan-sepeda-motor.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>#services">
